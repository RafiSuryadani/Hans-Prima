...
<head>
	...
	<!-- Simple Datatable -->
	<link rel="stylesheet" href="<?= base_url() ?>template/dist/assets/extensions/simple-datatables/style.css">
	<link rel="stylesheet" crossorigin href="<?= base_url() ?>template/dist/assets/compiled/css/table-datatable.css">
...
<body>
	<script src="<?= base_url() ?>template/dist/assets/static/js/initTheme.js"></script>
	<div id="app">
		<div id="sidebar">
		...
		<div id="main">
			...
			<?= $this->include('admin/_layouts/footer') ?>
	...
	<script src="<?= base_url() ?>template/dist/assets/compiled/js/app.js"></script>

	<!-- Need: Apexcharts -->
	<script src="<?= base_url() ?>template/dist/assets/extensions/apexcharts/apexcharts.min.js"></script>
	<script src="<?= base_url() ?>template/dist/assets/static/js/pages/dashboard.js"></script>
